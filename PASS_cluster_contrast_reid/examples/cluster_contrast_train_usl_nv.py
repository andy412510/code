...
from clustercontrast.utils.data.preprocessor_train import Preprocessor_train
...
def get_fake_loader(args, dataset, height, width, batch_size, workers,
                     num_instances, iters, trainset=None, index=False):
    if args.self_norm:
    ...
    train_loader = IterLoader(
        DataLoader(Preprocessor_train(train_set, root=dataset.images_dir, transform=train_transformer, index=index),
...
def main_worker(args):
    ...
    dataset_fake = get_data(args.dataset, args.fake_dir)
    ...
    for epoch in range(args.epochs):
        ...
        train_loader = get_fake_loader(args, dataset_fake, args.height, args.width,
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('-d', '--dataset', type=str, default='msmt17_v2',  # market1501, msmt17_v2
    ...
    parser.add_argument('--fake-dir', type=str, metavar='PATH',
                        default='/home/andy/ICASSP_data/data_fake/')
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default='./log/cluster_contrast_reid/market1501/pass_vit_small_cat_singleneck')
